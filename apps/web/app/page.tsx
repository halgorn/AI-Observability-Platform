  ...
  return (
    <div className="p-8 max-w-3xl">
      ...
      <div className="grid grid-cols-3 gap-3">
        <a href="/runs" className="block p-4 border border-zinc-800 rounded-lg hover:border-violet-500 transition-colors">
          <div className="text-sm font-semibold mb-1">Runs</div>
          <div className="text-xs text-zinc-500">Browse, search, drill into trace</div>
        </a>
        <a href="/agents" className="block p-4 border border-zinc-800 rounded-lg hover:border-violet-500 transition-colors">
          <div className="text-sm font-semibold mb-1">Agents</div>
          <div className="text-xs text-zinc-500">Handoff graph + success rate</div>
        </a>
        <a href="/tools" className="block p-4 border border-zinc-800 rounded-lg hover:border-violet-500 transition-colors">
